...
param(
    [Parameter()]
    [string]$OutputPath = 'C:\DSC\WindowsServer2022DC',
    
    [Parameter()]
    [string[]]$ComputerName = 'localhost',
    
    [Parameter()]
    [string]$OrgSettings = "$PSScriptRoot\OrgSettings-WindowsServer2022DC.xml",
...
configuration WindowsServer2022DC_STIG
{
    param
    (
        [Parameter()]
...
try
{
    ...
    WindowsServer2022DC_STIG @compileParams
